...
class tMockBoardGraph
{
public:
    tMockBoardGraph(tMockBoard const &mb) : xBoard(mb) {}
private:
    tMockBoard const &xBoard;
};
int
main()
{
...
*/
    tMockBoard mockBoard;
    // fill mockBoard with tracks
    typedef tMockBoardGraph graph_t;
    graph_t g(mockBoard);

//    breadth_first_search(g, vertex(s, g), visitor(vis));
    breadth_first_search(g, mockBoard[0], visitor(vis));
